...
/** Translation by arb.digital | https://git.io/vrHYt */
...
(function(){
	...
	if (m >= b || m <= e) {
		...
		wrapper.innerHTML = '<div class="nightnight"><div>Уже поздно&hellip;</div><div> Ничего из того, что мы может вам предложить, важнее вашего сна.</div> <div> Доброй ночи, сладких снов, и мы увидимся с вами утром.</div> <div class="nightnight-timing">Этот сайт проснется в ' + 
			time + 
			'</div> <div class="nightnight-skip"> <a href="javascript:nightnightHide()">Я посплю позже, мне правда нужно попасть на сайт сейчас &rightarrow;</a> </div> <div class="nightnight-credits"> <a href="https://www.nightnight.xn--q9jyb4c"><img src="https://code.nightnight.xn--q9jyb4c/static/night_night_everyone_white.png" alt="night night" height="32" width="161"></a></div> </div>';
